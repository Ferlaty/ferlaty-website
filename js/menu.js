        ...
        <div class="p-4">
          <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5 content-fill">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-200">Go to the home page</p>
            </div>
          </div>
          <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-200">Stay up to date by reading the news</p>
            </div>
          </div>
          <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
            <div
            ...
            <div>
              ...
              <p class="mt-1 text-gray-200">Our social media accounts</p>
            </div>
          </div>
          <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
            <div
            ...
            <div>
              ...
              <p class="mt-1 text-gray-200">Explore our content</p>
            </div>
          </div>
          <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
            <div
            ...
            <div>
              ...
              <p class="mt-1 text-gray-200">Know us better</p>
            </div>
          </div>
        </div>
